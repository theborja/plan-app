...
export type TrainingDayOfWeek = "Tue" | "Wed" | "Sat" | "Sun";

const DAY_ORDER: DayOfWeek[] = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
const TRAINING_DAYS: TrainingDayOfWeek[] = ["Tue", "Wed", "Sat", "Sun"];
...
export function isTrainingDay(day: DayOfWeek): day is TrainingDayOfWeek {
  return TRAINING_DAYS.includes(day as TrainingDayOfWeek);
}

export function getNextTrainingDay(fromIsoDate: string): {
  isoDate: string;
...
console.log(isTrainingDay("Sat")); // true
console.log(getNextTrainingDay("2026-02-13")); // { isoDate: "2026-02-14", dayOfWeek: "Sat" }
console.log(getNutritionWeekIndex("2026-02-14", "2026-02-09")); // 1
console.log(getNutritionWeekIndex("2026-02-17", "2026-02-09")); // 2
*/
